<template>
  <Layout>
    ...
    <p>
      Apply at: <a href="https://tinyurl.com/cloudcomputingdecal">https://tinyurl.com/cloudcomputingdecal</a>
    </p>
    <h4>Logistics</h4>
    <ul>
      <li><b>Instructors:</b> Ari Rigan, Shane Fan</li>
      <li><b>Course Staff:</b> Cyrus Bugwadia, Jie Luo, Sumer Kohli, Rachel Wang, Ryan Searcy, Smit Rajyaguru, Vanshaj Singhania</li>
    ...
    <ul>
      <li><b>Required Texts: </b> <i>TBD</i></li>
      <li><b>Recommended Texts and Other Readings: </b> <i>TBD</i></li>
    </ul>
    ...
    <p>
      <b>Important Note:</b> This syllabus, along with course assignments and due dates, are subject to change. It is the student’s responsibility to check our course Canvas site for corrections or updates to the syllabus. Any changes will be clearly noted in course announcements.
    </p>
    ...
    <ul>
      <li><b>Passing (P):</b> 70%-100%</li>
      <li><b>Not Passing (NP):</b> 0%-70%</li>
    </ul>
    ...
    <h4>Statement on Classroom Climate</h4>
    <p>
